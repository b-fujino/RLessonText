...
>>>>>>> bbc62a0b56019eaceb2e6242ea27afcae80f69eb
## 点プロット
...
<<<<<<< HEAD
平均を棒グラフとして，さらに標準偏差や標準誤差をエラーバーとして描く方法としては，あらかじめ算出した平均，標準偏差の値を使って描く方法と，データそのものを使って描く方法（ggplotの内部で平均や標準偏差を自動的に計算させる方法）の2つの方法がある．
=======
:::work
