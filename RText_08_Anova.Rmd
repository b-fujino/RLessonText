...
:::ref
被験者内計画での実験を行う際には，各被験者は設定したすべての実験条件を体験することになる．その場合，どの順序で各条件を体験したのかが結果に影響を与えてしまう可能性がある（例えば，どういう条件であっても最初に体験した条件は印象が強くなる，など）．こうした影響のことを**順序効果**と呼ぶ．こうした順序効果を排除するために，実施順序を入れ替えた群を設け，元の群のデータと実施順序を入れ替えた群のデータを合算する，という方法が一般によく取られる．被験者内計画での実験では順序効果をいかに除くかが非常に重要である．
